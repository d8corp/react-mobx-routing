...
var Link = /** @class */ (function (_super) {
    ...
    Link.prototype.render = function () {
        ...
        var _a = this.props, activeClass = _a.activeClass, exact = _a.exact, scrollTo = _a.scrollTo, scrollFirst = _a.scrollFirst, replace = _a.replace, href = _a.href, onMove = _a.onMove, _b = _a.rel, rel = _b === void 0 ? isLocal ? undefined : 'noreferrer' : _b, _c = _a.target, target = _c === void 0 ? isLocal ? undefined : '_blank' : _c, props = tslib.__rest(_a, ["activeClass", "exact", "scrollTo", "scrollFirst", "replace", "href", "onMove", "rel", "target"]);
