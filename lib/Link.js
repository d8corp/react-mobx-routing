...
var Link = /** @class */ (function (_super) {
    ...
    Link.prototype.onClick = function (e) {
        var _a = this.props, href = _a.href, scrollTo = _a.scrollTo, scrollFirst = _a.scrollFirst, replace = _a.replace;
        var url = href;
        if (href.startsWith('?')) {
    ...
    Link.prototype.render = function () {
        ...
        var _a = this.props, activeClass = _a.activeClass, exact = _a.exact, scrollTo = _a.scrollTo, scrollFirst = _a.scrollFirst, replace = _a.replace, _b = _a.rel, rel = _b === void 0 ? isLocal ? undefined : 'noreferrer' : _b, _c = _a.target, target = _c === void 0 ? isLocal ? undefined : '_blank' : _c, props = tslib.__rest(_a, ["activeClass", "exact", "scrollTo", "scrollFirst", "replace", "rel", "target"]);
        return React__default.createElement("a", tslib.__assign({}, props, { rel: rel, target: target, onClick: function (e) { return _this.onClick(e); }, className: this.className }));
    };
