...
let Link = /** @class */ (() => {
    let Link = class Link extends Component {
        ...
        render() {
            const { isLocal } = this;
            const _a = this.props, { activeClass, exact, scrollTo, scrollFirst, replace, href, onMove, rel = isLocal ? undefined : 'noreferrer', target = isLocal ? undefined : '_blank' } = _a, props = __rest(_a, ["activeClass", "exact", "scrollTo", "scrollFirst", "replace", "href", "onMove", "rel", "target"]);
